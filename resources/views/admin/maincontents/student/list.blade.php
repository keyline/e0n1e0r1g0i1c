                ...
                <?php if(count($rows)>0){ $sl=1; foreach($rows as $row){?>
                  <tr>
                    ...
                    <td>
                      ...
                      ?>
                      <a href="<?=url('admin/' . $controllerRoute . '/label-marks/'.Helper::encoded($row->id))?>" class="btn btn-primary btn-sm" title="Edit <?=$module['title']?>"><i class="fa fa-clock"></i> Level Wise Marks (<?=$labelCount?>)</a>
                    </td>
                  </tr>
                <?php } } else {?>
                  <tr>
