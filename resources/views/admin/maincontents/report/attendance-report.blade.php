  ...
  function openAttendanceModal(userId, name, date) {
    ...
    $.ajax({
        ...
        success: function(response) {
          ...
          $('#attendance_info_popup .modal-body').html(modal_html);

          // Show the modal
          var myModal = new bootstrap.Modal(document.getElementById('attendance_info_popup'));
          myModal.show();
        },
